...
CREATE TABLE IF NOT EXISTS `CRONOS_007_MENSAGEM`(
	ID INT NOT NULL
    , ID_TO INT
    , ID_FROM INT 
    , TEXTO VARCHAR(255)
...
ALTER TABLE `CRONOS_007_MENSAGEM`		ADD CONSTRAINT CR_PK_007 PRIMARY KEY (`ID`);
...
ALTER TABLE `CRONOS_007_MENSAGEM`	ADD CONSTRAINT CR_FK_007_01A FOREIGN KEY (`ID_TO`) 		REFERENCES `CRONOS_001_USUARIO`(`ID`);
ALTER TABLE `CRONOS_007_MENSAGEM`	ADD CONSTRAINT CR_FK_007_01B FOREIGN KEY (`ID_FROM`) 	REFERENCES `CRONOS_001_USUARIO`(`ID`);
...
ALTER TABLE `CRONOS_007_MENSAGEM`		CHANGE `ID` `ID` INT(11) NOT NULL AUTO_INCREMENT;
